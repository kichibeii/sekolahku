  ...
  <body>
    <div class="main-header">
      <div class="row">
        ...
        <div class="col-xs-12 col-md-10">
          ...
          <ul class="navatas nav navbar-nav navbar-right">
            <li>
              <a>
    ...
    <div class="utama">
      <div id="main-sidebar">
        ...
        <div class="menukiri">
          <ul>
            <a href="#"><li style="border-right: 3px solid #D52C25; border-radius: 5px;"><strong>Beranda</strong></li></a>
            <!-- <a href="biodata.php"><li>Biodata</li></a> -->
            <a href="nilai.php"><li>Nilai</li></a>
